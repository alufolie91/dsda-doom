...
#ifndef __DSDA_CORE_STATIC_VEC_HPP__
#define __DSDA_CORE_STATIC_VEC_HPP__
...
bool operator==(const dsda::StaticVec<T, L1>& lhs, const dsda::StaticVec<T, L2>& rhs)
{
...
template <typename T, size_t Limit>
struct std::hash<dsda::StaticVec<T, Limit>>
{
	size_t operator()(const dsda::StaticVec<T, Limit>& input) const
	{
...
#endif // __DSDA_CORE_STATIC_VEC_HPP__
